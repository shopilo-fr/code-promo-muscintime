#!/usr/bin/env python3
"""
Recuperation des codes promo Musc Intime depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/muscintime.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/muscintime.fr"
STORE_NAME = "Musc Intime"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Musc Intime depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-muscintime)"
    }
    try:
